...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/conjugaison/aimer', name: 'conj-aimer', component: () => import('../views/conjugaison/aimer.vue') },
    { path: '/conjugaison/donner', name: 'conj-donner', component: () => import('../views/conjugaison/donner.vue') },
    { path: '/conjugaison/manger', name: 'conj-manger', component: () => import('../views/conjugaison/manger.vue') },
    { path: '/conjugaison/commencer', name: 'conj-commencer', component: () => import('../views/conjugaison/commencer.vue') },
    { path: '/conjugaison/acheter', name: 'conj-acheter', component: () => import('../views/conjugaison/acheter.vue') },
    { path: '/conjugaison/appeler', name: 'conj-appeler', component: () => import('../views/conjugaison/appeler.vue') },
    { path: '/conjugaison/choisir', name: 'conj-choisir', component: () => import('../views/conjugaison/choisir.vue') },
    ...
    { path: '/conjugaison/dire', name: 'conj-dire', component: () => import('../views/conjugaison/dire.vue') },
    ...
    { path: '/conjugaison/devoir', name: 'conj-devoir', component: () => import('../views/conjugaison/devoir.vue') },
    { path: '/conjugaison/savoir', name: 'conj-savoir', component: () => import('../views/conjugaison/savoir.vue') },
    { path: '/conjugaison/voir', name: 'conj-voir', component: () => import('../views/conjugaison/voir.vue') },
    { path: '/conjugaison/venir', name: 'conj-venir', component: () => import('../views/conjugaison/venir.vue') },
    { path: '/conjugaison/partir', name: 'conj-partir', component: () => import('../views/conjugaison/partir.vue') },
    { path: '/conjugaison/sortir', name: 'conj-sortir', component: () => import('../views/conjugaison/sortir.vue') },
    { path: '/conjugaison/prendre', name: 'conj-prendre', component: () => import('../views/conjugaison/prendre.vue') },
    { path: '/conjugaison/mettre', name: 'conj-mettre', component: () => import('../views/conjugaison/mettre.vue') },
    { path: '/conjugaison/attendre', name: 'conj-attendre', component: () => import('../views/conjugaison/attendre.vue') },
    { path: '/conjugaison/ecrire', name: 'conj-ecrire', component: () => import('../views/conjugaison/ecrire.vue') },
    { path: '/conjugaison/lire', name: 'conj-lire', component: () => import('../views/conjugaison/lire.vue') },
    { path: '/conjugaison/boire', name: 'conj-boire', component: () => import('../views/conjugaison/boire.vue') },
    { path: '/conjugaison/ouvrir', name: 'conj-ouvrir', component: () => import('../views/conjugaison/ouvrir.vue') },
    { path: '/conjugaison/connaitre', name: 'conj-connaitre', component: () => import('../views/conjugaison/connaitre.vue') },
    ...
    { path: '/musique/la-vie-en-rose', name: 'musique-la-vie-en-rose', component: () => import('../views/musique/la-vie-en-rose.vue') },
    ...
    { path: '/vocabulaire/la-nourriture', name: 'vocab-la-nourriture', component: () => import('../views/vocabulaire/la-nourriture.vue') },
