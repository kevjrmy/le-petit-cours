...
<template>
  <DefaultLayout title="Demander son chemin">
    <main class="gapfill">
      ...
      <div class="scene">
        <p class="scene-intro">
          🧭 Julia est à Lyon. Elle cherche la gare et demande son chemin à une passante.
          Glissez les mots à la bonne place, ou écrivez-les (les accents ne comptent pas).
        </p>
        <p class="scene-hint">
          <em>(Julia está en Lyon y busca la estación. Arrastra o escribe las palabras; los acentos no cuentan.)</em>
        </p>
      </div>
      ...
      <div class="chat">
        <template v-for="(line, i) in dialogue" :key="i">
          <div class="bubble-row" :class="line.who">
            <span class="speaker">{{ line.who === 'right' ? 'Julia' : 'La passante' }}</span>
            <p class="bubble">
      ...
      <div v-if="checked" class="result" :class="{ perfect: allCorrect }">
        <span v-if="allCorrect">🎉 Bravo ! Julia va trouver la gare !</span>
        <span v-else>
 ...
 * `grammaire/l-imperatif` — both currently teach these phrases but nothing
 * makes the learner produce them.
 * Each blank: id, answer (canonical), accept (extra accepted spellings).
 */
const dialogue = [
  { who: 'right', parts: [
    { text: 'Pardon, madame ! Je ' },
    { id: 1, answer: 'cherche' },
    { text: ' la gare, s\'il vous plaît.' },
  ]},
  { who: 'left', parts: [
    { text: 'La gare ? Ce n\'est pas très ' },
    { id: 2, answer: 'loin' },
    { text: '. Vous êtes à pied ?' },
  ]},
  { who: 'right', parts: [
    { text: 'Oui, je suis à pied. C\'est par ' },
    { id: 3, answer: 'où' },
    { text: ' ?' },
  ]},
  { who: 'left', parts: [
    { text: 'Alors, ' },
    { id: 4, answer: 'allez', accept: ['Allez'] },
    { text: ' tout droit jusqu\'au feu rouge.' },
  ]},
  { who: 'right', parts: [
    { text: 'D\'accord... et ensuite ?' },
  ]},
  { who: 'left', parts: [
    { text: 'Ensuite, ' },
    { id: 5, answer: 'tournez', accept: ['Tournez'] },
    { text: ' à ' },
    { id: 6, answer: 'gauche' },
    { text: ' et ' },
    { id: 7, answer: 'traversez', accept: ['Traversez'] },
    { text: ' la place.' },
  ]},
  { who: 'right', parts: [
    { text: 'Je traverse la place... et après ?' },
  ]},
  { who: 'left', parts: [
    { id: 8, answer: 'Prenez', accept: ['prenez'] },
    { text: ' la deuxième rue à ' },
    { id: 9, answer: 'droite' },
    { text: '. La gare est juste ' },
    { id: 10, answer: 'en face', accept: ['en face de'] },
    { text: ' de la poste.' },
  ]},
  { who: 'right', parts: [
  ...
  { who: 'left', parts: [
    { text: 'À peu près dix minutes. Vous ne pouvez pas vous tromper !' },
  ]},
  { who: 'right', parts: [
    { id: 12, answer: 'Merci', accept: ['merci'] },
    { text: ' beaucoup, madame ! Bonne journée !' },
  ]},
]
