...
<template>
  <DefaultLayout title="Au restaurant">
    <main class="gapfill">

      <div class="scene">
        <p class="scene-intro">
          🍽️ Elena dîne au restaurant avec une amie. Elle commande son repas, puis
          demande l'addition. Glissez les mots à la bonne place, ou écrivez-les
          (les accents ne comptent pas).
        </p>
        <p class="scene-hint">
          <em>(Elena cena en un restaurante y pide la cuenta. Arrastra o escribe las palabras; los acentos no cuentan.)</em>
        </p>
      </div>
      ...
      <div class="chat">
        <template v-for="(line, i) in dialogue" :key="i">
          <div class="bubble-row" :class="line.who">
            <span class="speaker">{{ line.who === 'right' ? 'Elena' : 'Le serveur' }}</span>
            <p class="bubble">
      ...
      <div v-if="checked" class="result" :class="{ perfect: allCorrect }">
        <span v-if="allCorrect">🎉 Bravo ! Elena a bien dîné — et elle a payé le bon prix !</span>
        <span v-else>
...
/**
 * Fait produire ce que la section « Au restaurant » de
 * `vocabulaire/la-nourriture` se contente d'enseigner : l'ordre des plats, la
 * différence entre LA CARTE (la carta) et LE MENU (el menú del día), la carafe
 * d'eau gratuite et l'addition.
 *
 * Chaque blanc : id, answer (forme canonique), accept (autres graphies admises).
 *
 * La banque contient exactement un jeton par blanc, et c'est ce qui tranche les
 * cas où deux mots tiendraient dans la même phrase : placer « table » là où il
 * faut « carte » laisse forcément un trou ailleurs, et la vérification signale
 * les deux. Là où la grammaire peut décider seule, on la laisse faire —
 * « la ___ » exclut « menu », qui est masculin, et « ___ principal » exclut
 * « entrée » et « dessert ».
 */
const dialogue = [
  { who: 'left', parts: [
    { text: 'Bonsoir mesdames ! Vous avez ' },
    { id: 1, answer: 'réservé' },
    { text: ' ?' },
  ]},
  { who: 'right', parts: [
    { text: 'Non, désolée. Vous avez une ' },
    { id: 2, answer: 'table' },
    { text: ' pour deux personnes ?' },
  ]},
  { who: 'left', parts: [
    { text: 'Oui, installez-vous près de la fenêtre. Voici la ' },
    { id: 3, answer: 'carte' },
    { text: '. Je vous laisse choisir.' },
  ]},
  { who: 'right', parts: [
    { text: 'Merci. Est-ce que vous avez un ' },
    { id: 4, answer: 'menu' },
    { text: ' à prix fixe ?' },
  ]},
  { who: 'left', parts: [
    { text: 'Oui, à vingt-deux euros : une entrée, un plat et un dessert.' },
  ]},
  { who: 'right', parts: [
    { text: 'Parfait. Comme ' },
    { id: 5, answer: 'entrée' },
    { text: ', je vais prendre la soupe de légumes.' },
  ]},
  { who: 'left', parts: [
    { text: 'Très bien. Et comme ' },
    { id: 6, answer: 'plat' },
    { text: ' principal ?' },
  ]},
  { who: 'right', parts: [
    { text: 'Le poulet, s\'il vous plaît.' },
  ]},
  { who: 'left', parts: [
    { text: 'Et pour ' },
    { id: 7, answer: 'boire' },
  ...
  { who: 'right', parts: [
    { text: 'Une ' },
    { id: 8, answer: 'carafe' },
    { text: ' d\'eau, s\'il vous plaît. Elle est gratuite, non ?' },
  ]},
  { who: 'left', parts: [
    { text: 'Bien sûr, madame. Et vous prendrez un ' },
    { id: 9, answer: 'dessert' },
    { text: ' ?' },
  ]},
  { who: 'right', parts: [
    { text: 'Oui, une glace à la vanille. Merci !' },
  ]},
  { who: 'left', parts: [
    { text: 'Je vous apporte tout ça.' },
  ]},
  { who: 'right', parts: [
    { text: 'C\'était délicieux. L\'' },
    { id: 10, answer: 'addition' },
    { text: ', s\'il vous plaît !' },
  ]},
  { who: 'left', parts: [
    { text: 'Voilà. Le service est compris, le ' },
    { id: 11, answer: 'pourboire' },
    { text: ' n\'est pas obligatoire.' },
  ]},
  { who: 'right', parts: [
    { id: 12, answer: 'Merci', accept: ['merci'] },
    { text: ' beaucoup ! Bonne soirée !' },
  ]},
]
