      ...
      <div class="chat">
        <template v-for="(line, i) in dialogue" :key="i">
          <div class="bubble-row" :class="line.who">
            <span class="speaker">{{ line.who === 'right' ? 'Lucas' : 'Le pharmacien' }}</span>
            <p class="bubble">
...
/**
 * Drills the symptom vocabulary of `vocabulaire/le-docteur` and the
 * `avoir mal à` structure it shares with `vocabulaire/le-corps`.
 *
