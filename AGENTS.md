...
- **Brand assets take their colour from the page** (#28). The wordmark is a CSS mask over
  `currentColor`, so it follows the theme. The icons are generated by `node scripts/make-icons.mjs`
